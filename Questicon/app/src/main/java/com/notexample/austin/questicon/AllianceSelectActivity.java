...
public class AllianceSelectActivity extends AppCompatActivity {
    ...
    public void clickingFrameDraenei(View view) {
        ...
        builder1.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(AllianceSelectActivity.this, DraeneiAcitivity.class);
                        startActivity(intent);
    ...
    public void clickingFrameNightElf(View view) {
        ...
        builder1.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(AllianceSelectActivity.this, NightElfActivity.class);
                        startActivity(intent);
