...
public class WallpaperAcitivty extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ImageView im;
...
//        getMenuInflater().inflate(R.menu.main, menu);
    ...
    public void clickingCharacter(MenuItem item) {
        Intent intent = new Intent(WallpaperAcitivty.this, CharacterActivity.class);
        startActivity(intent);
    }

    public void clickingBosses(MenuItem item) {
        Intent intent = new Intent(WallpaperAcitivty.this, BossesActivity.class);
        startActivity(intent);
    }

    public void clickingDungeons(MenuItem item) {
        Intent intent = new Intent(WallpaperAcitivty.this, DungeonActivity.class);
        startActivity(intent);
    }

    public void clickingMounts(MenuItem item) {
        Intent intent = new Intent(WallpaperAcitivty.this, MountsActivity.class);
        startActivity(intent);
    }

    public void clickingPets(MenuItem item) {
        Intent intent = new Intent(WallpaperAcitivty.this, PetsActivity.class);
        startActivity(intent);
    }


    public void clickingLore(MenuItem item) {
        Intent intent = new Intent(WallpaperAcitivty.this, LoreActivity.class);
        startActivity(intent);
    }


    public void clickingGallery(MenuItem item) {
        Intent intent = new Intent(WallpaperAcitivty.this, WallpaperAcitivty.class);
        startActivity(intent);
    }


    public void clickingMusic(MenuItem item) {
        Intent intent = new Intent(WallpaperAcitivty.this, MusicActivity.class);
        startActivity(intent);
    }


    public void clickingChooser(MenuItem item) {
        Intent intent = new Intent(WallpaperAcitivty.this, SplashScreenLoadingCharacters.class);
        startActivity(intent);
    }
}
